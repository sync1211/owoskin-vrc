namespace OWOVRC.UI
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            audioInformationGroup = new GroupBox();
            audioInformationLabel = new Label();
            label21 = new Label();
            ...
            audioInformationGroup.SuspendLayout();
            ...
            audioResponsePage.Controls.Add(audioInformationGroup);
            ...
            // 
            // audioInformationGroup
            // 
            audioInformationGroup.Controls.Add(audioInformationLabel);
            audioInformationGroup.Location = new Point(6, 173);
            audioInformationGroup.Name = "audioInformationGroup";
            audioInformationGroup.Size = new Size(348, 63);
            audioInformationGroup.TabIndex = 26;
            audioInformationGroup.TabStop = false;
            audioInformationGroup.Text = "Information";
            // 
            // audioInformationLabel
            // 
            audioInformationLabel.AutoSize = true;
            audioInformationLabel.FlatStyle = FlatStyle.Popup;
            audioInformationLabel.Font = new Font("Segoe UI", 9.75F, FontStyle.Italic, GraphicsUnit.Point, 0);
            audioInformationLabel.ForeColor = SystemColors.ControlDarkDark;
            audioInformationLabel.Location = new Point(16, 19);
            audioInformationLabel.Name = "audioInformationLabel";
            audioInformationLabel.Size = new Size(308, 34);
            audioInformationLabel.TabIndex = 20;
            audioInformationLabel.Text = "This effect attempts to create sensations based on the \r\nbass level of the system's audio output.\r\n";
            // 
            // label21
            // 
            ...
            audioInformationGroup.ResumeLayout(false);
            audioInformationGroup.PerformLayout();
        ...
        private GroupBox audioInformationGroup;
        private Label audioInformationLabel;
